...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// the nestedFunction has access to internal because that is how scope works is JS. Much like CSS and HTML the children (those wrapped in other functions) have access to what is outside of them
...
class CubeMaker extends CuboidMakerTwo {
  ...
  volume() {
    return this.width ** 3; // all the dimensions of a cube are the same so you can use an of them and the 'cube' it lol
  }
  surfaceArea() {
